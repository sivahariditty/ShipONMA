...
static const char qt_meta_stringdata_StatusPage[] = {
    "StatusPage\0"
};
...
const QMetaObjectExtraData StatusPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StatusPage::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_StatusPage,
      qt_meta_data_StatusPage, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StatusPage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StatusPage))

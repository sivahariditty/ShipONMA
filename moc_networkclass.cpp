...
static const char qt_meta_stringdata_NetworkClass[] = {
    "NetworkClass\0\0NetworkProcessing()\0"
    "ReciveData()\0"
};
...
void NetworkClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        NetworkClass *_t = static_cast<NetworkClass *>(_o);
        switch (_id) {
        case 0: _t->NetworkProcessing(); break;
        case 1: _t->ReciveData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData NetworkClass::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NetworkClass::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_NetworkClass,
      qt_meta_data_NetworkClass, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NetworkClass::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetworkClass))
